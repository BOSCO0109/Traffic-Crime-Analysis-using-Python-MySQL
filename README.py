...
engine = create_engine('mysql+mysqlconnector://root:1234567890@localhost:3306/bot') #This is called as engine used to connect with sql database through python query
